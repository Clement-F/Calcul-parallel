...
if convergence:
    f = open("tp2-exo1-convergence_001.txt", "r"); lines_1PCG = f.readlines()
    f = open("tp2-exo1-convergence_0025.txt", "r"); lines_2PCG = f.readlines()
    f = open("tp2-exo1-convergence_0005.txt", "r"); lines_3PCG = f.readlines()
    f = open("tp2-exo1-convergence_00025.txt", "r"); lines_4PCG = f.readlines()
...
if iterations:
    iter_CG = np.loadtxt("tp1-exo2-iterations.txt")
    iter_PCG = np.loadtxt("tp2-exo1-iterations_PCG.txt")
    h = iter_PCG[:, 0]
