...
int main() {
    std::ofstream iter("tp2-exo1-iterations_PCG.txt");
    ...
    if (carre_0025) {
        ...
        std::string filename = "tp2-exo1-convergence_0025.txt";
        std::ofstream myfile;
    ...
    if (carre_001) {
        ...
        std::string filename = "tp2-exo1-convergence_001.txt";
        std::ofstream myfile;
        myfile.open(filename);
        for (int i=1; i<maxIter; i++){
            myfile << Conv[i] << "\n";
    ...
    if (carre_0005) {
        ...
        std::string filename = "tp2-exo1-convergence_0005.txt";
        std::ofstream myfile;
        myfile.open(filename);
        for (int i=1; i<maxIter; i++){
            myfile << Conv[i] << "\n";
    ...
    if (carre_00025) {
        ...
        std::string filename = "tp2-exo1-convergence_00025.txt";
        std::ofstream myfile;
        myfile.open(filename);
        for (int i=1; i<maxIter; i++){
            myfile << Conv[i] << "\n";
